import { ActionFromMatcher, Matcher, UnionToIntersection } from './tsHelpers';
import { AsyncThunk, AsyncThunkFulfilledActionCreator, AsyncThunkPendingActionCreator, AsyncThunkRejectedActionCreator } from './createAsyncThunk';
/** @public */
 ...
 * @internal
 */
export declare function hasExpectedRequestMetadata(action: any, validStatus: string[]): boolean;
...
export declare type AnyAsyncThunk = AsyncThunk<any, any, any>;
