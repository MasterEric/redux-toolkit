...
function createSerializableStateInvariantMiddleware(options = {}) {
    ...
    const { isSerializable = isPlain, getEntries, ignoredActions = [], ignoredActionPaths = ["meta.arg"], ignoredPaths = [], warnAfter = 32, ignoreState = false } = options;
...
function createAsyncThunk(typePrefix, payloadCreator, options) {
    const fulfilled = createAction(typePrefix + "/fulfilled", (result, requestId, arg) => {
        return {
            payload: result,
            meta: {
                arg,
