(function (global, factory) {
    ...
    var __exportStar = function (target, module, desc) {
        if (module && typeof module === "object" || typeof module === "function") {
            ...
            for (var _b = 0, _c = __getOwnPropNames(module); _b < _c.length; _b++) {
                var key = _c[_b];
                _loop_1(key);
            }
        }
    ...
    var __toModule = function (module) {
        return __exportStar(__markAsModule(__defProp(module != null ? __create(__getProtoOf(module)) : {}, "default", module && module.__esModule && "default" in module ? { get: function () { return module.default; }, enumerable: true } : { value: module, enumerable: true })), module);
    };
    ...
    var require_es = __commonJS(function (exports, module) {
        __markAsModule(exports);
        __export(exports, {
            default: function () { return es_default2; }
        });
        var root;
    ...
    var MiddlewareArray = /** @class */ (function (_super) {
        ...
        MiddlewareArray.prototype.concat = function () {
            ...
            return new (MiddlewareArray.bind.apply(MiddlewareArray, __spreadArray([void 0], _super.prototype.concat.apply(this, arr))))();
        };
    ...
    function createSlice(options) {
        ...
        var finalCaseReducers = __assign(__assign({}, extraReducers), sliceCaseReducersByType);
    ...
    var RejectWithValue = /** @class */ (function () {
        function RejectWithValue(payload) {
    ...
    function createAsyncThunk(typePrefix, payloadCreator, options) {
        ...
        var rejected = createAction(typePrefix + "/rejected", function (error, requestId, arg) {
            ...
            return {
                payload: error instanceof RejectWithValue ? error.payload : void 0,
                                ...
                                case 0:
                                    ...
                                    return [4 /*yield*/, Promise.race([
                                            ...
                                            Promise.resolve(payloadCreator(arg, {
                                                ...
                                                rejectWithValue: function (value) {
